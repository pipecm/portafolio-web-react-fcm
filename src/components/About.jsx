    ...
    <section id="about" className="bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold">Acerca de</h2>
          ...
          <div className="lg:w-2/3 space-y-4 animate-slide-in">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center glass-card p-4">
                <div className="text-3xl text-secondary font-bold">2009</div>
                <div className="text-gray-600">Desarrollando software desde</div>
              </div>
              <div className="text-center glass-card p-4">
                <div className="text-3xl text-secondary font-bold">15+</div>
                <div className="text-gray-600">Años de Experiencia Total</div>
              </div>
              <div className="text-center glass-card p-4">
